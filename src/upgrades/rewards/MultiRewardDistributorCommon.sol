...
interface MultiRewardDistributorCommon {
    ...
    struct ReferralData {
        address referrer; // The referrer of the user
        uint256 rewards; // Rewards earned by the referrer
        address[] referees; // List of users referred by this address
    }
