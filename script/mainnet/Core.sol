...
contract CoreScript is Test, Script, Configuration {
    ...
    uint256 public constant ASSET_INITIAL_DEPOSIT = 10;
    ...
    /// @notice no contracts are deployed in this proposal    /// @notice no contracts are deployed in this proposal
    function deployAsset() public {
        ...
        for (uint256 i = 0; i < hTokenConfigsLength; i++) {
            ...
            addAddress(config.tokenAddressName, config.tokenAddress, block.chainid, true);
